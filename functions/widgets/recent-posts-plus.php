...
class RecentPostsPlus extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('count') ); ?>"><?php _e('Number of posts to show:', 'vh'); ?></label>
        ...
        <p>
            <?php if( current_theme_supports('post-thumbnails') ): ?>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id('include_post_thumbnail') ); ?>"><?php _e('Include post thumbnail', 'vh'); ?></label><br>
            <?php endif; ?>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('include_post_excerpt') ); ?>"><?php _e('Include post excerpt', 'vh'); ?></label><br>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('show_expert_options') ); ?>"><?php _e('Show expert options', 'vh'); ?></label>
        </p>

        <div class="rpp_expert-panel" style="display:none; margin-top: 10px">

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('truncate_post_title') ); ?>"><?php _e('Limit post title:', 'vh'); ?></label>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id('truncate_post_excerpt') ); ?>"><?php _e('Limit post excerpt:', 'vh'); ?></label>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id('truncate_elipsis') ); ?>"><?php _e('Limit ellipsis:', 'vh'); ?></label>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id('post_date_format') ); ?>"><?php _e('Post date format:', 'vh'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a>
            ...
            <?php if( current_theme_supports('post-thumbnails') ): ?>
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id('post_thumbnail_width') ); ?>"><?php _e('Thumbnail size (WxH):', 'vh'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('wp_query_options') ); ?>"><?php _e('WP_Query Options', 'vh'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('widget_output_template') ); ?>"><?php _e('Widget Output Template', 'vh'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a><br />
