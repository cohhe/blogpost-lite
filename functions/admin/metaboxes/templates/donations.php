...
<div class="row-container">
	<div class="misc-pub-section" style="padding-left: 0;">
		...
		<span>$ <input type="text" name="<?php echo esc_attr($id); ?>" value="<?php echo esc_attr($how_many_donations_are_needed); ?>" /></span>
	</div>
	<div class="misc-pub-section" style="padding-left: 0;">
		<strong>Donations so far: </strong><br />
		$ <input type="text" name="_donations_so_far" value="<?php echo esc_attr($current_donations); ?>" />
	</div>
	<div class="misc-pub-section" style="padding-left: 0;">
		<strong>Fundraisers: </strong><br />
		&nbsp;&nbsp;&nbsp;<input type="text" name="_fundraisers" value="<?php echo esc_attr($current_fundrainers); ?>" />
	</div>
	<div class="misc-pub-section" style="padding-left: 0; border-bottom: 0;">
		<strong>PayPal email: </strong><br />
		&nbsp;&nbsp;&nbsp;<input type="text" name="_custom_paypal_email" value="<?php echo esc_attr($paypal_email); ?>" />
