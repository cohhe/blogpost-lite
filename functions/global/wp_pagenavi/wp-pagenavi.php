...
function wp_pagenavi($before = '', $after = '') {
	...
	if (!is_single()) {
		...
		if ($max_page > 1 || intval($pagenavi_options['always_show']) == 1) {
			echo $before . '<div class="vh-pages-wrapper span12 body-bg">' . "\n";
			switch (intval($pagenavi_options['style'])) {
				case 1:
					...
					if ($start_page >= 2 && $pages_to_show < $max_page) {
						...
						echo '<a href="' . esc_url(get_pagenum_link()) . '" class="first no_thickbox icon-angle-left" title="&laquo;"></a>';
					...
					if ($end_page < $max_page) {
						...
						echo '<a href="' . esc_url(get_pagenum_link($max_page)) . '" class="last no_thickbox icon-angle-right" title="&raquo;"></a>';
					}
					break;
				case 2;
...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text']                   = __('', 'vh');
	$pagenavi_options['current_text']                 = '%PAGE_NUMBER%';
	$pagenavi_options['page_text']                    = '%PAGE_NUMBER%';
	$pagenavi_options['first_text']                   = __('&laquo;', 'vh');
	$pagenavi_options['last_text']                    = __('&raquo;', 'vh');
	$pagenavi_options['next_text']                    = __('&raquo;', 'vh');
	$pagenavi_options['prev_text']                    = __('&laquo;', 'vh');
	$pagenavi_options['dotright_text']                = __('...', 'vh');
	$pagenavi_options['dotleft_text']                 = __('...', 'vh');
